    ...
    <aside class="sidebar-header d-inline-block" data-aos="fade-right" data-aos-duration="500">
        <nav>
            <ul>
                ...
                <li class="mb-4" data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><a href="{{ route('viaura.profile') }}" class="fw-700"><i class="fa-solid fa-user me-2"></i> Profile</a>
                </li>
