                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-8 ps-0 pe-4">
                        ...
                        <p class="fw-bold p-3" data-aos="fade-down" data-aos-duration="800" data-aos-delay="300">
                            Hi, I’m Aiden Harris, a Full Stack Developer with solid experience in building modern and
                            responsive web applications. I work with technologies like React, Node.js, and MongoDB to
                            create user-friendly frontends and powerful backends.
                            <br> <br>
                            I enjoy solving problems with clean, efficient code and always aim to deliver high-quality
                            results that help businesses grow. I pay close attention to performance, design, and user
                            experience in every project I build.
                            <br> <br>
                            Whether I'm working on an e-commerce site, a dashboard, or a custom web app, I’m always
                            focused on building things that are fast, reliable, and easy to use.
